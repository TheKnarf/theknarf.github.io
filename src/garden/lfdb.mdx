...
- Other interesting datamodels:
     ...
     - [Merkele Search Trees](https://inria.hal.science/hal-02303490/document) ([rust implementation](https://docs.rs/merkle-search-tree/0.8.0/merkle_search_tree/))
...
- [Dialog DB](https://github.com/dialog-db/dialog-db/) - I learned about Dialog DB from [their presentation at SyncConf 2025](https://schedule.2025.syncconf.dev/schedule/talks/your-data-your-rules)
